...
const api: HnvApi = {
  ...
  getvideo: {
    listChannels: (source: GvSource) => ipcRenderer.invoke('getvideo:listChannels', source),
    addChannel: (source: GvSource, url: string) => ipcRenderer.invoke('getvideo:addChannel', source, url),
    removeChannel: (id: string) => ipcRenderer.invoke('getvideo:removeChannel', id),
    refreshMeta: () => ipcRenderer.invoke('getvideo:refreshMeta'),
    syncMeta: (source: GvSource) => ipcRenderer.invoke('getvideo:syncMeta', source),
    logs: () => ipcRenderer.invoke('getvideo:logs'),
    update: (id: string) => ipcRenderer.invoke('getvideo:update', id),
    stop: () => ipcRenderer.invoke('getvideo:stop'),
    ...
    saveSettings: (s: Partial<GvSettings>) => ipcRenderer.invoke('getvideo:saveSettings', s)
  },
  channelSearch: {
