      ...
      <div className="w-[520px] bg-[#0d0e14] border border-border rounded-[14px] shadow-2xl overflow-hidden">
        <div className="px-[22px] py-4 border-b border-borderSoft flex items-center">
          <div className="text-[17px] font-bold">
            Chạy <span className="text-accent2">{templateName}</span> — chọn hồ sơ
          </div>
        ...
        <div className="px-[22px] py-4">
          <div className="flex gap-2.5 mb-2.5">
            <button
              onClick={() => setPicked(new Set(profiles.map((p) => p.id)))}
          ...
          <div className="text-[13px] h-[300px] overflow-y-auto hv-scroll">
            ...
            {filtered.length === 0 && <div className="text-muted py-2 px-2">Chưa có hồ sơ.</div>}
          </div>
        </div>
        <div className="px-[22px] py-3.5 border-t border-borderSoft flex gap-2.5 justify-end items-center">
          <div className="mr-auto text-[13px] text-muted">
            Đã chọn <b className="text-accent2">{picked.size}</b>
          </div>
          <button
            onClick={onClose}
          ...
          <button
            ...
            className="bg-[#1f3a2e] text-ok border border-[#2c5443] font-bold rounded-[9px] px-[22px] py-2.5 text-[14px] disabled:opacity-40"
          >
            ▶ Chạy {picked.size} hồ sơ
          </button>
        </div>
      </div>
    </div>
